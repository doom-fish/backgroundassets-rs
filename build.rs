...
fn main() {
    ...
    println!("cargo:rustc-link-lib=framework=ExtensionFoundation");
    ...
    let swift_triple = match target_arch.as_str() {
        ...
        other => panic!("backgroundassets: unsupported target arch '{other}'"),
    };
    ...
    println!("cargo:rustc-link-lib=static=BackgroundAssetsBridge");
